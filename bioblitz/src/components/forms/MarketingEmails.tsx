...
export default function MarketingEmails({ onAccept , onDecline}: { onAccept: () => void , onDecline: () => void}){
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-900/60 backdrop-blur-sm p-4">
            <div className="w-full max-w-md rounded-2xl border border-neutral-800 bg-neutral-900 shadow-2xl p-6">
                ...
                <div className="mb-5 space-y-2 text-xs text-neutral-400">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <button
                        onClick={onDecline}
                        className="w-full rounded-xl py-3 bg-neutral-800 hover:bg-neutral-700 text-neutral-300 transition-colors text-sm"
                    >
                        No thanks
                    </button>
                </div>
