...
export default function ProfileHeader({
  ...
  return (
    <div className="relative bg-gradient-to-b from-violet-900/20 to-transparent border-b border-zinc-900 pb-8">
      <div className="max-w-6xl mx-auto px-6 pt-8">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-6">
          <div className="relative group">
            <div
              className={`w-32 h-32 rounded-full ring-4 ring-violet-500/20 overflow-hidden bg-zinc-900 ${
            ...
            {isOwnProfile && (
              <button
                ...
                disabled={pfpLoading}
                className="absolute bottom-0 right-0 p-2.5 bg-violet-600 rounded-full text-white hover:bg-violet-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
              >
