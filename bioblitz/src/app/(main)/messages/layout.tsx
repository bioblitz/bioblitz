  ...
  return (
    <div className="min-h-screen bg-neutral-900">
      <main className="max-w-7xl mx-auto pl-4 md:pl-16 pr-0 pt-16 md:pt-24 pb-24 md:pb-0">
        <div className="flex h-[calc(100vh-6rem)] md:h-[calc(100vh-8rem)] rounded-2xl overflow-hidden border border-neutral-800/60">
          {" "}
          {/* Inbox list — always visible on desktop, hidden on mobile when a conversation is open */}
          <aside
            className={`
    w-full md:w-80 lg:w-96 shrink-0 border-r border-neutral-900 bg-neutral-950/30
